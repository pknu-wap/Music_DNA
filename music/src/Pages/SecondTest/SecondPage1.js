      ...
      {({ sectionRefs, handleScrollToNext }) => (
        <div className="firstPage">
          ...
          {[
            ...
            {
              id: 'SwingJazz1',
              text: '한손에는 레드 와인, 한손은 너의 허리에. 따뜻한 분위기 속 앙상블에 몸을 맡긴 난 특별한 사람이 된것만 같아.',
            },
            {
              id: 'SoulJazz1',
              text: '자욱한 어두운 바에 홀로 앉아 위스키 한 잔을 마시는 나. 흑인 보컬과 쫀득한 리듬이 날 더 취하게 해.',
            },
            {
              id: 'FreeJazz1',
              text: '불협화음이든 박자가 달라지든 아티스트 감정에만 충실한 음악은 내가 자유롭고 싶은 마음과 같아서 좋아!',
            },
            {
              id: 'BibobJazz1',
