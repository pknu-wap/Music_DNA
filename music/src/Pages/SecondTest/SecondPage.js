      ...
      {({ sectionRefs, handleScrollToNext }) => (
        <div className="firstPage">
          ...
          {[
            {
              id: 'DancePop1',
              text: '쿵! 짝! 쿵! 짝! 4/4박자로 마치 내 발걸음과 같은 이 비트와 에너지 넘치는 보컬.. 이런 음악은 역동적이고 강렬한 춤을 추게 만들어!',
            },
            {
              id: 'ElecPop1',
            ...
            {
              id: 'IndiPop1',
              text: '고정관념에서 벗어나 아티스트만의 철학과 예술적 발상이 느껴지는 다채로운 음악이 좋아.',
            },
            {
              id: 'LatinPop1',
              text: '멕시코, 스페인 클럽에서 나올듯한 탄탄한 리듬과 특유의 타악기 소리가 나를 삼바춤을 추게해.',
            },
          ].map((item, index) => (
            <div
              key={item.id}
