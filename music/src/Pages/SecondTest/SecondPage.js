      ...
      {({ sectionRefs, handleScrollToNext }) => (
        <div className="firstPage">
          ...
          {[
            {
              id: 'DancePop1',
              text: '쿵! 짝! 쿵! 짝! 발걸음 같은 비트와 에너지 넘치는 보컬! 이런 음악은 역동적이고 강렬한 춤을 추게 만들어.',
            },
            {
              id: 'ElecPop1',
              text: '고음질의 다양한 전자사운드! 마치 네온빛이 가득한 사이버펑크 세상에 온 것 같아.',
            },
            {
              id: 'BritPop1',
            ...
            {
              id: 'LatinPop1',
              text: '멕시코, 스페인 클럽에서 나올 듯 한 특유의 리틈과 타악기 소리가 나를 삼바춤 추게해.',
            },
          ].map((item, index) => (
            <div
              key={item.id}
