  ...
  return (
    <div className="firstPage">
      ...
      <div className="num1">
        ...
        <h3>
          <div class="q1">6번 사운드가 당신의 마음에 드나요?</div>
        </h3>
        <RockBox id="Rock2" />
      ...
      <div className="num1">
        ...
        <h3>
          <div class="q1">7번 사운드가 당신의 마음에 드나요?</div>
        </h3>
        <RbBox id="RB1" />
      ...
      <div className="num1">
        ...
        <h3>
          <div class="q1">8번 사운드가 당신의 마음에 드나요?</div>
        </h3>
        <RbBox id="RB2" />
      ...
      <div className="num1">
        ...
        <h3>
          <div class="q1">9번 사운드가 당신의 마음에 드나요?</div>
        </h3>
        <JazzBox id="Jazz1" />
      ...
      <div className="num1">
        <img
          onClick={() => playMusic(10)}
          src="./sound1.png"
          alt="Sound Icon"
        />
        <h3>
          <div class="q1">10번 사운드가 당신의 마음에 드나요?</div>
        </h3>
        <JazzBox id="Jazz2" />
